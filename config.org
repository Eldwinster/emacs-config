...
This is to solve this bug:

[[https://github.com/doomemacs/doomemacs/issues/7022][doomemacs/doomemacs#7022 IELM: "Error running timer ‘jit-lock-stealth-fontify...]]

#+begin_src emacs-lisp
(setq ielm-font-lock-keywords nil)
#+end_src
...
Trouve un moyen de hook ~dired-preview-mode~ quand dans un dired buffer y'a des
fichiers avec des extensions d'image. Si trop compliqué reste sur la solution
simple mais manuel.
