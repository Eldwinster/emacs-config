...
(after! org-roam
  (setq org-roam-capture-templates
        `(
          ...
          ("r" "random")
          ("rp" "Nom Prenom" plain
           (file "~/org/templates/random/PersonTemplate.org")
           :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org"
                              "#+title: ${title}\n")
           :unnarrowed t)

          ("s" "slip-box")
          ("sp" "Permanent note" plain
           (file "~/org/templates/slip-box/PermanentTemplate.org")
           :if-new
           (file+head "%<%Y%m%d%H%M%S>-${slug}.org"
                      "#+title: ${title}\n")
           :unnarrowed t)
          ("sr" "Reference note" plain
           (file "~/org/templates/slip-box/ReferenceTemplate.org")
           :if-new
           (file+head "${citekey}.org"
                      "#+title: ${title}")
           :unnarrowed t)
          ("sm" "Mind map note" plain
           (file "~/org/templates/slip-box/MindMapTemplate.org")
           :if-new
           (file+head "%<%Y%m%d%H%M%S>-${slug}.org"
                      "#+title: ${title}")
           :unnarrowed t)
          ...
          ("g" "Get Things Done")
          ("gp" "Project" plain
           (file "~/org/templates/GTD/ProjectTemplate.org")
          ...
          ("w" "Wiki")
          ("wi" "Issue" plain
           (file "~/org/templates/wiki/IssueTemplate.org")
           :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
           :unnarrowed t)
          ("wg" "Guide" plain
           (file "~/org/templates/wiki/GuideTemplate.org")
           :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
           :unnarrowed t)
          ("ww" "Wiki page" plain
           (file "~/org/templates/wiki/WikiTemplate.org")
           :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
           :unnarrowed t)

          ("b" "Blog")
          ("bp" "Page" plain
           (file "~/org/templates/blog/BlogPageTemplate.org")
           :if-new (file+head "blog-${slug}-%<%Y%m%d%H%M%S>.org"
                              "#+title: ${title}\n")
           :unnarrowed t)
          ("bw" "Write Up" plain
           (file "~/org/templates/blog/BlogWriteUpTemplate.org")
           :if-new (file+head "blog-${slug}-%<%Y%m%d%H%M%S>.org"
                              "#+title: ${title}\n")
           :unnarrowed t)
          ("ba" "Article" plain
           (file "~/org/templates/blog/BlogArticleTemplate.org")
           :if-new (file+head "blog-${slug}-%<%Y%m%d%H%M%S>.org"
                              "#+title: ${title}\n")
           :unnarrowed t)
          )))
...
;;
;;           ("md" "definition" plain
;;            (file "~/.org/roam/templates/DefinitionTemplate.org")
;;            :if-new
;;            (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
;;            :unnarrowed t)
;;           ("mt" "theoreme" plain
;;            (file "~/.org/roam/templates/TheoremeTemplate.org")
;;            :if-new
;;            (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
;;            :unnarrowed t)
;;           ("mp" "proposition" plain
;;            (file "~/.org/roam/templates/PropositionTemplate.org")
;;            :if-new
;;            (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
;;            :unnarrowed t)
;;           ("mc" "corollaire" plain
;;            (file "~/.org/roam/templates/CorollaireTemplate.org")
;;            :if-new
;;            (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
;;            :unnarrowed t)
;;           ("ml" "lemme" plain
;;            (file "~/.org/roam/templates/LemmeTemplate.org")
;;            :if-new
;;            (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}")
;;            :unnarrowed t)
#+end_src
